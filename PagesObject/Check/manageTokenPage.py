...
class ManageTokenPage:
    def __init__(self, driver, helps):
        ...
        elements = self.help.get_element('Check', 'sendFile')
        try:
            self.txtAbaNumber = self.wait.until(ec.visibility_of_element_located((By.ID, elements['txtAbaNumber']['css'])))
    ...
    def clickTxtAbaNumber(self):
        ...
        if len(error) == 0:
            self.help.info_log(self.page, "The Text Aba Number is clicked correctly")
        else:
