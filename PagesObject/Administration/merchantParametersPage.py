...
class MerchantParametersPage:
    ...
    def clickcheckavs_all(self, option):
        error = list()
        fill = dict()
        method = "Checkbox AVS"

        for a in range(1, 18):
            parameterscheckavs = self.wait.until(ec.element_to_be_clickable((By.CSS_SELECTOR, "#app>div>main>div>div>div>div.row.align-center.justify-center>div>div>div>div:nth-child(1)>div>div>div>div.v-window.v-item-group.theme--light.v-tabs-items>div>div.v-window-item.v-window-item--active>div>div.v-card__text>div>div:nth-child(" + str(a) + ")>div>div>div.v-input__slot>div>div")))
            parameterscheckavsvalue = self.wait.until(ec.presence_of_element_located((By.CSS_SELECTOR, "#app>div>main>div>div.container.custom-container.container--fluid>div>div.row.align-center.justify-center>div>div>div>div:nth-child(1)>div>div>div>div.v-window.v-item-group.theme--light.v-tabs-items>div>div>div>div.v-card__text>div>div:nth-child(" + str(a) + ")>div>div>div.v-input__slot>div>input[type=checkbox]")))

            if parameterscheckavsvalue.get_attribute("aria-checked") != option:
                error += self.help.click_button(self.page, parameterscheckavs)
    ...
    def clickcheckzip_all(self, option):
        error = list()
        fill = dict()
        method = "Checkbox Zip"

        for a in range(1, 19):
            parameterscheckzip = self.wait.until(ec.element_to_be_clickable((By.CSS_SELECTOR, "#app>div>main>div>div>div>div.row.align-center.justify-center>div>div>div>div:nth-child(1)>div>div>div>div.v-window.v-item-group.theme--light.v-tabs-items>div>div.v-window-item.v-window-item--active>div>div.v-card__text>div>div:nth-child(" + str(a) + ")>div>div>div.v-input__slot>div>div")))
            parameterscheckzipvalue = self.wait.until(ec.presence_of_element_located((By.CSS_SELECTOR, "#app>div>main>div>div.container.custom-container.container--fluid>div>div.row.align-center.justify-center>div>div>div>div:nth-child(1)>div>div>div>div.v-window.v-item-group.theme--light.v-tabs-items>div>div.v-window-item.v-window-item--active>div>div.v-card__text>div>div:nth-child(" + str(a) + ")>div>div>div.v-input__slot>div>input[type=checkbox]")))
            print(parameterscheckzipvalue.get_attribute("aria-checked"))
            if parameterscheckzipvalue.get_attribute("aria-checked") != option:
    ...
    def clickcheckcvv_all(self, option):
        error = list()
        fill = dict()
        method = "Checkbox Cvv"

        for a in range(1, 12):
            parameterscheckcvv = self.wait.until(ec.element_to_be_clickable((By.CSS_SELECTOR, "#app>div>main>div>div>div>div.row.align-center.justify-center>div>div>div>div:nth-child(1)>div>div>div>div.v-window.v-item-group.theme--light.v-tabs-items>div>div.v-window-item.v-window-item--active>div>div.v-card__text>div>div:nth-child(" + str(a) + ")>div>div>div.v-input__slot>div>div")))
            parameterscheckcvvvalue = self.wait.until(ec.presence_of_element_located((By.CSS_SELECTOR, "#app>div>main>div>div.container.custom-container.container--fluid>div>div.row.align-center.justify-center>div>div>div>div:nth-child(1)>div>div>div>div.v-window.v-item-group.theme--light.v-tabs-items>div>div.v-window-item.v-window-item--active>div>div.v-card__text>div>div:nth-child(" + str(a) + ")>div>div>div.v-input__slot>div>input[type=checkbox]")))

            if parameterscheckcvvvalue.get_attribute("aria-checked") != option:
    ...
    def actionsModifyMerchantParametersAvsZipCvv(self, option):

        self.clicktabavs()
        self.clickcheckavs_all(option)
        self.clicktabzip()
        self.clickcheckzip_all(option)
        self.clicktabcvv()
        self.clickcheckcvv_all(option)
