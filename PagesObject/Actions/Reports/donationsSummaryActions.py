...
from PagesObject.Pages.Reports.donationsSummaryPage import DonationsSummaryPage


class DonationsSummaryActions:
    def __init__(self, driver, helps):
        self.driver = driver
        self.help = helps
        self.error = list()
        self.page = "Donations Summary Actions Page"
        ...
        self.errorsubmenu = self.submenu.clickSubmenu("DonationsSummary")
        if len(self.errorsubmenu) != 0:
            self.error.append(self.errorsubmenu)
        self.help.info_log(self.page, "Submenu Auth -> ok.")

        self.form = DonationsSummaryPage(self.driver, self.help)
