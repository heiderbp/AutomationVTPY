...
from PagesObject.Pages.Reports.EBPPReconciliationPage import EBPPReconciliationPage


class EBPPReconciliationActions:
    def __init__(self, driver, helps):
        self.driver = driver
        self.help = helps
        self.error = list()
        self.page = "EBPP Reconciliation Actions Page"
        ...
        self.errorsubmenu = self.submenu.clickSubmenu("EBPPReconciliation")
        if len(self.errorsubmenu) != 0:
            self.error.append(self.errorsubmenu)
        self.help.info_log(self.page, "Submenu Auth -> ok.")

        self.form = EBPPReconciliationPage(self.driver, self.help)
