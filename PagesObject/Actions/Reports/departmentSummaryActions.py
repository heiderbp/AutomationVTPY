...
from PagesObject.Pages.Reports.departmentSummaryPage import DepartmentSummaryPage


class DepartmentSummaryActions:
    def __init__(self, driver, helps):
        self.driver = driver
        self.help = helps
        self.error = list()
        self.page = "Department Summary Actions Page"
        ...
        self.errorsubmenu = self.submenu.clickSubmenu("DepartmentSummary")
        if len(self.errorsubmenu) != 0:
            self.error.append(self.errorsubmenu)
        self.help.info_log(self.page, "Submenu Auth -> ok.")

        self.form = DepartmentSummaryPage(self.driver, self.help)
