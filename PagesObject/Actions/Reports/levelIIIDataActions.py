...
from PagesObject.Pages.Reports.levelIIIDataPage import LevelIIIDataPage


class LevelIIIDataActions:
    def __init__(self, driver, helps):
        self.driver = driver
        self.help = helps
        self.error = list()
        self.page = "Level III Data Actions Page"
