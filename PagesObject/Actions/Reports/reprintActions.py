...
from PagesObject.Pages.Reports.reprintPage import ReprintPage


class ReprintActions:
    def __init__(self, driver, helps):
        self.driver = driver
        self.help = helps
        self.error = list()
        self.page = "Reprint Actions Page"
