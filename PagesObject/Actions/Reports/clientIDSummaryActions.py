...
from PagesObject.Pages.Reports.clientIDSummaryPage import ClientIDSummaryPage


class ClientIDSummaryActions:
    def __init__(self, driver, helps):
        self.driver = driver
        self.help = helps
        self.error = list()
        self.page = "Client ID Summary Actions Page"
        ...
        self.errorsubmenu = self.submenu.clickSubmenu("ClientIDSummary")
        if len(self.errorsubmenu) != 0:
            self.error.append(self.errorsubmenu)
        self.help.info_log(self.page, "Submenu Auth -> ok.")

        self.form = ClientIDSummaryPage(self.driver, self.help)
