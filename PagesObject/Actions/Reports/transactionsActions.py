...
from PagesObject.Pages.Reports.transactionsPage import TransactionsPage
...
class TransactionsActions:
    def __init__(self, driver, helps):
        ...
        self.help = helps
        self.error = list()
        self.page = "Transactions Actions Page"
