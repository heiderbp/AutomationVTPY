...
from PagesObject.Pages.Reports.supervisorPage import SupervisorPage
...
class SupervisorActions:
    def __init__(self, driver, helps):
        ...
        self.help = helps
        self.error = list()
        self.page = "Supervisor Actions Page"
