...
from PagesObject.Pages.Reports.checkReportPage import CheckReportPage

class CheckReportActions:
    def __init__(self, driver, helps):
        self.driver = driver
        self.help = helps
        self.error = list()
        self.page = "Check Report Actions Page"
