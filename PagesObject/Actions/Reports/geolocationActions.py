...
from PagesObject.Pages.Reports.geolocationPage import GeolocationPage
...
class GeolocationActions:
    def __init__(self, driver, helps):
        ...
        self.help = helps
        self.error = list()
        self.page = "Geolocation Actions Page"
