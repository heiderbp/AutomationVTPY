...
class TransactionDistributionPage:
    def __init__(self, driver, helps):
        self.driver = driver
        self.help = helps
        self.page = "Transaction Distribution Page"

        error = list()
        self.error = dict()
        self.wait = WebDriverWait(self.driver, 5)
        elements = self.help.get_element('Reports', 'transactionDistribution')
        try:
    ...
    def clickCmbDataSeries(self):
        error = list()
        fill = dict()
        method = "Transaction Distribution"
