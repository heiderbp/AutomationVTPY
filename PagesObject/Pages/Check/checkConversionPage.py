...
class CheckConversionPage:
    def __init__(self, driver, helps):
        ...
        try:
            self.cmbMerchant = self.wait.until(ec.visibility_of_element_located((By.CSS_SELECTOR, "#app>div>main>div>div.container.custom-container.container--fluid>div>div.row.align-center.justify-center>div>div:nth-child(1)>div.col-lg-5.col-12>div>div.v-card__text.custom>form>div:nth-child(1)>div.col-lg-7.col-12>div>div>div.v-input__slot")))
