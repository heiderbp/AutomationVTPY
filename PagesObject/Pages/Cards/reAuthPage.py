...
class ReAuthPage:
    def __init__(self, driver, helps):
        ...
        try:
            self.txtReferenceNumber = self.wait.until(ec.visibility_of_element_located((By.ID, "referenceNumber")))
    ...
    def clickTxtReferenceNumber(self):
        ...
        if len(error) == 0:
            self.help.info_log(self.page, "The Text Reference Number is clicked correctly")
        else:
