...
from PagesObject.Actions.Reports.reprintActions import ReprintActions


class ClickReportsReprintDataSeries(dashBoardConditions):
    page = "Reprint page"

    def test_ClickDataSeries(self):
        self.name_test = "Click Combobox Data Series"
        actions = ReprintActions(self.driver, self.help)
